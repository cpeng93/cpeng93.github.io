...
let defaultViewMatrix = [0.89,-0.01,-0.43,0,-0.23,0.82,-0.51,0,0.36,0.57,0.74,0,-2.6,-0.32,3.58,1];
...
async function main() {
    ...
    const url = new URL(
        // "nike.splat",
        // location.href,
        params.get("url") || "jhu_ground_AMES_spring_GTA_pano_2025-05-12_14_3A10_3A45.splat",
